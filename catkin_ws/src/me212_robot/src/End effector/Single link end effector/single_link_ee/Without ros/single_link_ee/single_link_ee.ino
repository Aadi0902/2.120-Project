...
const float q1_limit =  70 * M_PI / 180; // joint angle limit for q1 (rad), M_PI is slightly more accurate and more portable then PI
...
//    y_e = l_1*sin(asin((y_e_up-l_2*sin(theta_up))/l_1)) + l_2*sin(theta);
    ...
    #ifdef home_pos
    i = i + 1;
    y_e = y_e_up - i*(y_e_up - y_e_down)/(period_us/10); // Change 1000 for tuning
    ...
    theta = theta_home;//theta_down + i*(theta_home - theta_down)/(period_us/10);
    #endif
    // ================================================================
    // ===                    GET SETPOINT                          ===
    // ================================================================
