...
set_base()
{
  ...
  case "$(basename $configParentDir)" in
    "dead_reckon") export CODE_BASE=$(dirname $configParentDir);;
...
alias matlabdrake='cd $CODE_BASE/dead_reckon; matlab -r "addpath_pods; addpath_drake"'
alias matlabpokebot='cd $CODE_BASE/dead_reckon; matlab -nodesktop -nodisplay -nosplash -r "tic; addpath_pods; addpath_drake; toc; cd ../dead_reckon/planning/ik_server/; ikTrajServerSocket;"'
...
alias pman='bot-procman-sheriff -l $CODE_BASE/dead_reckon/config/procman.pmd'
